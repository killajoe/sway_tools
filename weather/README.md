# sway-openweather - script to show weather on waybar or others
...
* save script in your path w.g. $HOME/.local/bin/, make it executable and use it in your waybar / bar config
